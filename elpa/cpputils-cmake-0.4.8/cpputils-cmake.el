...
(defvar cppcm-include-dirs nil "Value example: (\"-I/usr/include/c++/4.8\" \"-I./inc\")")
...
(defun cppcm-reload-all ()
  ...
  (when cppcm-include-dirs
    ...
    ;;                       (concat "/usr/include//i386-linux-gnu/c++/" gpp-version)
    ;;                       (concat "/usr/include/c++/" gpp-version "/ext")
    ;;                       (concat "/usr/include/c++/" gpp-version "/backward")
    ;;                       (concat "/usr/lib/gcc/i686-linux-gnu/" gpp-version "/include")
    ;;                       (concat "/usr/lib/gcc/i686-linux-gnu/" gpp-version "/include-fixed")
